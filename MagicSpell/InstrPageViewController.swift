...
class InstrPageViewController: UIViewController{
    ...
    var imageArray = [UIImage(named: "install_01")!, UIImage(named: "install_02")!, UIImage(named: "install_03")!, UIImage(named: "install_04")!, UIImage(named: "install_05")!, UIImage(named: "install_06")!];
    ...
    func makeViews() {
        ...
        imageAnimation.animationDuration = 6
        imageAnimation.animationRepeatCount = 0
        imageAnimation.startAnimating()
        imageAnimation.setWidth(400)
        imageAnimation.setHeight(400)
